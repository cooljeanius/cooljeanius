...
- 📫 How to reach me: Twitter: [@cooljeanius](https://twitter.com/cooljeanius) ...or CounterSocial: @egallager <sub><sup>(or, use the email address associated with my commits – do `git log` in one of my repos to see it)</sup></sub>
- 😄 Pronouns: he/him
